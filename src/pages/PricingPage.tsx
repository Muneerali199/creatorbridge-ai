...
const plans = [
  {
    ...
    features: [
      'Personal TrueScore dashboard — scan yourself anytime',
      'FraudShield self-check — see if brands trust you',
      'Value calculator — know your worth (₹ per post)',
      'Appear in brand discovery results',
      'DealMatch — get discovered by brands',
